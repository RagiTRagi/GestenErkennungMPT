...
class HMMClassifier:
    ...
    """
    # 10 Zustaende: mit 3 war die Accuracy deutlich schlechter (0.38 statt 0.86)
...
if __name__ == "__main__":
    ...
    #   uv run GestureRecognition/hmmclassifier.py dataset_augmented.pkl  -> anderer Datensatz
    import os
    import sys
